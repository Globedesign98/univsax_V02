...
- Utiliser l'API de saisies pour trouver le label d'un champ extra (cas des saisies `case` où il vaut mieux utiliser `label_case`)
- Fichiers de langue SPIP 4.1+

### Changed

- Compatible SPIP >= 4.1 seulement
- Logo à la racine
