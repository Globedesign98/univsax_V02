...
/*
 * Squelette : squelettes/inc-ues-header.html
 * Date :      Fri, 13 Feb 2026 20:31:56 GMT
 * Compile :   Sun, 22 Feb 2026 23:51:12 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette squelettes/inc-ues-header.html
// Temps de compilation total: 0.061 ms
//

function html_65429caad56cbc86781cbef88ccb9164($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
'">
      ...
      <button aria-controls="uesNav" aria-expanded="false" aria-label="Ouvrir le menu"
              class="navbar-toggler ues-toggler" data-bs-target="#uesNav" data-bs-toggle="collapse" type="button">
      ...
      <div class="collapse navbar-collapse" id="uesNav">
        <ul class="navbar-nav ms-auto ues-menu">
          ...
          <li class="nav-item active"><a class="nav-link" href="spip.php?rubrique5">Inscriptions 2026</a></li>
	...
	return analyse_resultat_skel('html_65429caad56cbc86781cbef88ccb9164', $Cache, $page, 'squelettes/inc-ues-header.html');
}
