...
function html_be01841bf7aa106d1d8dbd5fa90b4d2b($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
		...
		$(".liste_items.documents.ordonner_rang_lien[data-lien]").find(\'> .sortable\').each(function () {
			...
			new Sortable(this, {
				...
				onUpdate: function (event) {
					...
					const action = \'' .
retablir_echappements_modeles(generer_url_action('ordonner_liens_documents','','1')) .
'\';
					const params = {
	...
	jQuery(function($){
		if (!$.js_portfolio_documents_charge) {
			...
			if (typeof Sortable === "undefined") {
				jQuery.getScript(\'' .
retablir_echappements_modeles(timestamp(find_in_path((string)'prive/javascript/Sortable.js'))) .
...
');
	...
	return analyse_resultat_skel('html_be01841bf7aa106d1d8dbd5fa90b4d2b', $Cache, $page, '../plugins-dist/medias/javascript/gestion_listes_documents.js.html');
}
