...
function BOUCLE_artsrhtml_04d363d2866c6dc2442ce29a44f75855(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = Spip\Compilateur\Iterateur\Factory::create(
		"SQL",
		$command,
		array('../prive/squelettes/inclure/accueil-information.html','html_04d363d2866c6dc2442ce29a44f75855','_artsr',11,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
function BOUCLE_restreintshtml_04d363d2866c6dc2442ce29a44f75855(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_statut('rubriques.statut','!','publie',''), 'JOIN-L1' => 
	...
	$iter = Spip\Compilateur\Iterateur\Factory::create(
		"SQL",
		$command,
		array('../prive/squelettes/inclure/accueil-information.html','html_04d363d2866c6dc2442ce29a44f75855','_restreints',10,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
'
				' .
BOUCLE_artsrhtml_04d363d2866c6dc2442ce29a44f75855($Cache, $Pile, $doublons, $Numrows, $SP)
...
function BOUCLE_artshtml_04d363d2866c6dc2442ce29a44f75855(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = Spip\Compilateur\Iterateur\Factory::create(
		"SQL",
		$command,
		array('../prive/squelettes/inclure/accueil-information.html','html_04d363d2866c6dc2442ce29a44f75855','_arts',6,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
(($t1 = BOUCLE_restreintshtml_04d363d2866c6dc2442ce29a44f75855($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		($t1 . (	'
				' .
...
function BOUCLE_cpthtml_04d363d2866c6dc2442ce29a44f75855(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = Spip\Compilateur\Iterateur\Factory::create(
		"DATA",
		$command,
		array('../prive/squelettes/inclure/accueil-information.html','html_04d363d2866c6dc2442ce29a44f75855','_cpt',6,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
	while ($Pile[$SP]=$iter->fetch()) {
		...
		$t0 .= BOUCLE_artshtml_04d363d2866c6dc2442ce29a44f75855($Cache, $Pile, $doublons, $Numrows, $SP);
	}
	$iter->free();
	}
	if (defined("_BOUCLE_PROFILER")
...
function BOUCLE_autshtml_04d363d2866c6dc2442ce29a44f75855(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = Spip\Compilateur\Iterateur\Factory::create(
		"SQL",
		$command,
		array('../prive/squelettes/inclure/accueil-information.html','html_04d363d2866c6dc2442ce29a44f75855','_auts',25,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
function BOUCLE_cptahtml_04d363d2866c6dc2442ce29a44f75855(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = Spip\Compilateur\Iterateur\Factory::create(
		"DATA",
		$command,
		array('../prive/squelettes/inclure/accueil-information.html','html_04d363d2866c6dc2442ce29a44f75855','_cpta',25,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
	while ($Pile[$SP]=$iter->fetch()) {
		...
		$t0 .= (
BOUCLE_autshtml_04d363d2866c6dc2442ce29a44f75855($Cache, $Pile, $doublons, $Numrows, $SP)
. (	'
			' .
...
function html_04d363d2866c6dc2442ce29a44f75855($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
'
' .
(($t1 = BOUCLE_cpthtml_04d363d2866c6dc2442ce29a44f75855($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
	<h4>' .
...
<div class=\'accueil_informations auteurs liste\'>
	' .
(($t1 = BOUCLE_cptahtml_04d363d2866c6dc2442ce29a44f75855($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
		<h4>' .
...
');
	...
	return analyse_resultat_skel('html_04d363d2866c6dc2442ce29a44f75855', $Cache, $page, '../prive/squelettes/inclure/accueil-information.html');
}
