...
function html_9e243b5b8fac61ab4488cdd7e4806a3d($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
.onglets_simple .medias > li:not(.tout):not(.file) > * {
...
');
	...
	return analyse_resultat_skel('html_9e243b5b8fac61ab4488cdd7e4806a3d', $Cache, $page, '../plugins-dist/medias/prive/style_prive_plugin_medias.html');
}
