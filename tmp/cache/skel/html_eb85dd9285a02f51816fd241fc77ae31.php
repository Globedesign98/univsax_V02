...
function BOUCLE_enlignehtml_eb85dd9285a02f51816fd241fc77ae31(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = Spip\Compilateur\Iterateur\Factory::create(
		"SQL",
		$command,
		array('../prive/objets/liste/auteurs_enligne.html','html_eb85dd9285a02f51816fd241fc77ae31','_enligne',5,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
function html_eb85dd9285a02f51816fd241fc77ae31($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
	...
	$connect = '';
	$page = (
(($t1 = BOUCLE_enlignehtml_eb85dd9285a02f51816fd241fc77ae31($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
<div class="en_lignes">
	<div class="largeur">
		<b>' .
...
');
	...
	return analyse_resultat_skel('html_eb85dd9285a02f51816fd241fc77ae31', $Cache, $page, '../prive/objets/liste/auteurs_enligne.html');
}
