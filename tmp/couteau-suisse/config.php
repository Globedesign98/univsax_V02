...
$liste_outils = array(
	...
	// Blocs Dépliables
	'blocs' => 'blocs_ancre|bloc_unique|blocs_cookie|bloc_h4|blocs_couper|blocs_slide|blocs_millisec|pp_edition_blocs|pp_forum_blocs|pp_vide_blocs',
	...
	// SPIP et le cache…
	'spip_cache' => 'radio_desactive_cache4|quota_cache_nb|derniere_modif_invalide|duree_cache|duree_cache_mutu|compacte_css|compacte_js|compacte_prive|compacte_tout',
	// Format des URLs
