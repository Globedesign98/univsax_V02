...
Do not submit this import request.<p>For more information, please see <a href="@spipnet@">the SPIP documentation</a>.</p>',
	...
	'info_compositeur' => 'Are you a composer?',
	'info_droits_auteur' => 'Are you registered with a copyright organization?',
...
via FTP.</p>',
 ...
 for the public area of the site (subscription-only forums).',
  ...
  Languages already used on your site (at the top of the list) cannot be disabled.',
	...
	'info_remarque' => 'Comments',
	'info_nom' => 'Name',
	'info_prenom' => 'First name',
	'info_sex' => 'Sex',
	'info_male' => 'Male',
	'info_female' => 'Female',
	'info_adresse' => 'Adress',
	'info_ad_plan' => 'Adress',
	'info_codepostal' => 'Postal Code',
	'info_ville' => 'City',
	'info_pays' => 'Country',
	'info_tel' => 'Phone',
	'info_oui' => 'yes',
	'info_non' => 'no',
	'info_sante' => 'Health-specific conditions (allergies, asthma, etc.) that must be reported',
	'info_pers' => 'Nobody to close in case of hospitalization or of force majeure, to indicate absolutely',
	'info_vegetarian' => 'Vegetarian',
	'info_villars' => 'Accommodation at the Foyer Des Jeunes Travailleurs',
	'info_place' => 'Place of pursuit(continuation) of musical studies',
	'info_ecole' => 'Name and place of your music school',
	'info_typesax' => 'What saxophone do you bring?',
	'info_typebec' => 'What beak do you bring?',
	'info_prof' => 'Name of your professor',
	'info_music' => 'Piece of music prepared for the European University of Saxophone',
	'info_saxo' => 'What saxophone and beak do you bring?',
	'info_ensemble' => 'Choice of practice of set',
	'info_quatuor' => 'Quartet',
	'info_music_ch' => 'Chamber music',
	'info_group' => 'Group Sax',
	'info_sound' => 'Initiation aux musiques traditionnelles de la péninsule balkanique',
	'info_paiement' => 'Method of payment chosen by the student',
	'info_virement' => 'Transfert payment',
	'info_reglement' => 'Regulation 2025',
	'info_aucun' => 'None',
	'info_reglement_txt' => 'I have read the participation Rules and I accept them. ',
  ...
  .',
	...
	'info_nouvel_article' => 'Name of the student',
...
<p>These files can be used to restrict access to authors and administrators to other parts of your site (for instance, external statistical programme).</p><p>If you have no need of such files, you can keep this option with its default value (no file creation).</p>',
 ...
 database.',
  ...
  reindexed. This command is therefore only useful in exceptional circumstances.',
	...
	'texte_proposer_publication' => 'Send your form.',
